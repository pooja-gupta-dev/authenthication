...
import 'package:authenthication/instagram_project/insta_videoupload_screen.dart';
import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
...
class SignUp_Register_Screen extends StatefulWidget {
  @override
  _SignUp_Register_ScreenState createState() => _SignUp_Register_ScreenState();
}

class _SignUp_Register_ScreenState extends State<SignUp_Register_Screen> {
  final TextEditingController nameController = TextEditingController();
  final TextEditingController emailController = TextEditingController();
  final TextEditingController passwordController = TextEditingController();
  final TextEditingController phoneController = TextEditingController();
